 ...
 *
 * Depende: auth_teste.js (validateLogin, saveSession, loadSession, clearSession,
 *          isAdmin) + theme_teste.css (estilos .login-screen, .topbar etc).
 * ============================================================
 */
...
function injectTopbar(opts) {
  ...
  topbar.innerHTML = `
    ...
    <div class="ac-topbar-right">
      ...
      ${showBack ? `<a class="ac-back-link" href="admin_teste.html">${escapeHtml(i18n.back)}</a>` : ''}
