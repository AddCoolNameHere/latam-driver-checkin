/* ============================================================
 * sv-shell_teste.js — sidebar enterprise COMUM + gating por permissão.
 *
 * Inclua <script src="sv-shell_teste.js"></script> antes de </body>.
...
(function () {
  ...
  ensureLink("sv-skin_teste.css?v=3");
  ...
  var NAV = [
    { label: "Operação", items: [
      { label: "Dashboard",      href: "dashboard_teste.html",      icon: "home",     access: "all" },
      { label: "Drivers",        href: "driver-profile_teste.html", icon: "users",    access: "all" },
      { label: "Recruitment",    href: "recruitment_teste.html",    icon: "userPlus", access: "all" },
      { label: "Country Scopes", href: "country_scopes_teste.html", icon: "layers",   access: "admin" },
      { label: "PMO Hub",        href: "pmo_teste.html",            icon: "notes",    access: "admin" },
    ]},
    { label: "Financeiro", items: [
      ...
      { label: "Funds",           href: "ramp_teste.html",                   icon: "wallet", access: "all" },
      { label: "Payroll",         href: "timesheet_teste.html",              icon: "report", access: "all" },
      { label: "Divergências AR",  href: "ar-divergencias-admin_teste.html", icon: "alert",  access: "all" },
    ]},
    { label: "Relatórios", items: [
      { label: "Cenários Argentina",   href: "argentina_scenarios_presentation_teste.html", icon: "chart",    access: "admin" },
      { label: "Otimização Argentina", href: "argentina_optimization_report_teste.html",    icon: "fileText", access: "admin" },
    ]},
    { label: "Sistema", items: [
      { label: "Usuários", href: "admin-users_teste.html", icon: "settings", access: "super" },
      { label: "Roadmap",  href: "roadmap_teste.html",     icon: "map",      access: "super" },
    ]},
  ];
  ...
  function here() { return (location.pathname.split("/").pop() || "dashboard_teste.html").toLowerCase(); }
